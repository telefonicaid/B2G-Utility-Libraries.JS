...
if (typeof OAuth === "undefined" || !OAuth.Request) {
    (function() {
        ...
        function newOAuthParams(callback,consumerKey,accessToken) {
                ...
                oauthParams.oauth_timestamp = Math.round((Date.now() / 1000)).toString();
            ...
            function generateOAuth(request,credentials,options) {
                ...
                oparams.oauth_signature = generateSignature(allParams,credentials.consumerSecret,
            ...
            function generateSignature(request,consumerSecret,accessTokenSecret) {
                ...
                for(var c = 0; c < total; c++) {
                    ...
                    parameterString += keys[c] + '=' + val.toString().to_rfc3986();
                    if(c < total - 1) {
                        parameterString += '&';
                    }
                ...
                request.httpRequest.baseURL.to_rfc3986() + "&" + parameterString.to_rfc3986();
                
                window.console.log('Signature Base String: ' + signatureBaseString);
